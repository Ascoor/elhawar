    ...
    public function up()
    {
        ...
        foreach ($companies as $company){
            $widgets = [
                ...
                ['company_id' => $company->id,'widget_name' => 'total_members', 'status' => 1],  //mostafa modification
                ...
                ['company_id' => $company->id,'widget_name' => 'member_feedbacks', 'status' => 1], //mostafa modification
