...
class CreateSeoDetailsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $seoDetail->seo_description = 'CODAGETECH saas is easy to use CRM software that is designed for B2B. It include  everything you need to run your businesses. like manage customers, projects, invoices, estimates, timelogs, contract and much more.';
        $seoDetail->save();
        ...
        $seoDetail = new SeoDetail();
        $seoDetail->page_name = 'sports';
        $seoDetail->seo_title = 'Sports';
        $seoDetail->seo_author = $globalSetting ? $globalSetting->company_name : 'CODAGETECH';
        $seoDetail->seo_keywords = 'best crm,hr management software, web hr software, hr software online, free hr software, hr software for sme, hr management software for small business, cloud hr software, online hr management software';
        $seoDetail->seo_description = 'CODAGETECH saas is easy to use CRM software that is designed for B2B. It include  everything you need to run your businesses. like manage customers, projects, invoices, estimates, timelogs, contract and much more.';
        $seoDetail->save();
