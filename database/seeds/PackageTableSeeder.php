...
class PackageTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $package->sort = 0;
        $package->module_in_package = '{"1":"clients","2":"employees","3":"attendance","4":"projects","5":"tasks","6":"estimates","7":"invoices","8":"payments","9":"expenses","10":"timelogs","11":"tickets","12":"messages","13":"events","14":"leaves","15":"notices","16":"leads","17":"holidays","18":"products","19":"members","20":"sportAcademies","21":"sportTeams","22":"players","23":"championships","24":"trips","25":"purchases","26":"inventories","27":"libraries","28":"archives","29":"legalAffairs"}';
        $package->save();
        ...
        $package->sort = 1;
        $package->module_in_package = '{"1":"clients","2":"employees","3":"attendance","4":"projects","5":"tasks","6":"estimates","7":"invoices","8":"payments","9":"expenses","10":"timelogs","11":"tickets","17":"holidays","19":"members","20":"sportAcademies","21":"sportTeams","22":"players","23":"championships","24":"trips","25":"purchases","26":"inventories","27":"libraries","28":"archives","29":"legalAffairs"}';
        ...
        $package->billing_cycle = 10;
        $package->sort = 2;
        $package->module_in_package = '{"1":"clients","2":"employees","3":"attendance","4":"projects","5":"tasks","6":"estimates","7":"invoices","8":"payments","9":"expenses","10":"timelogs","11":"tickets","12":"messages","13":"events","14":"leaves","15":"notices","16":"leads","17":"holidays","19":"members","20":"sportAcademies","21":"sportTeams","22":"players","23":"championships","24":"trips","25":"purchases","26":"inventories","27":"libraries","28":"archives","29":"legalAffairs"}';
