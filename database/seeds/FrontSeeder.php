...
class FrontSeeder extends Seeder
{
    ...
    private function detail(){
        ...
        $frontDetails->address = '14 50st Zone 13, Maadi, Cairo, Egypt.';
        $frontDetails->phone = '01016542830';
        $frontDetails->email = 'info@codagetech.com';
        ...
        $trFrontDetail->task_management_title  = 'Sports Management';
        $trFrontDetail->task_management_detail = 'Manage your championships and your talented members in a single system, resulting in empowered teams, satisfied members, and increased profitability.';
        $trFrontDetail->manage_bills_title     = 'Manages Sport Academies Training has never been easier.';
        $trFrontDetail->manage_bills_detail    = 'Join El Hawar Community and Enjoy the best organized ever services.';
        $trFrontDetail->teamates_title         = 'Manages All championships.';
        $trFrontDetail->teamates_detail        = 'Automate your membership renewal.';
        ...
        $trFrontDetail->cta_title              = 'Managing Sport Clubs Has Never Been So Easy.';
        ...
        $trFrontDetail->client_title           = 'Trusted by the world\'s best clubs';
        $trFrontDetail->client_detail          = 'More Than 700 People Use Our Product.';
        $trFrontDetail->testimonial_title      = 'One of the biggest sport clubs in Egypt.';
        $trFrontDetail->faq_title              = 'Frequently Asked Questions';
        $trFrontDetail->footer_copyright_text  = 'CODAGETECH Copyright © 2022. All Rights Reserved';
        $trFrontDetail->header_title = 'Sport Clubs Management System';
        $trFrontDetail->header_description = 'The most powerful and simple way to communicate within our club community.<ul class="list1 border-top pt-5 mt-5">
                            <li class="mb-3">
                                Create Sport Academies
                            </li>
                            <li class="mb-3">
                                Training Schedules
                            </li>
                            <li class="mb-3">
                                Add club’s employees, track their attendance and manage leaves
                            </li>
                        </ul>';
        $trFrontDetail->feature_title = 'Sport Clubs Management for the 21st century.';
        $trFrontDetail->price_title = 'Professional Sports Academies';
        $trFrontDetail->price_description = 'We offer the most professional training courses ever that will qualify the next generation champions.';

        $trFrontDetail->save();
    }
    private function features(){
        $feature = new \App\Feature();
        $feature->title = 'Meet Our Community';
        ...
        $feature->description = "<p>Manage your projects and your talent in a single system, resulting in empowered teams, satisfied clients, and increased profitability.</p><ul class=\"list1 border-top pt-5 mt-5\">
                            <li class=\"mb-3\">
                                Keep a track of physical and medical records for your kids.
                            </li>
                            <li class=\"mb-3\">
                                Keep record of your kids level during their academies training.
                            </li>
                            <li class=\"mb-3\">
                                Join our events and trips with just few clicks.
                            </li>
                        </ul>";
        $feature->type = 'image';
        $feature->save();
        ...
        $feature = new \App\Feature();
        $feature->title = 'Online Membership Renewal';
        // $feature->image = 'everywhere.png';
        $feature->description = "<p>Never spend time in a que to renew your membership</p><ul class=\"list1 border-top pt-5 mt-5\">
                            <li class=\"mb-3\">
                                Online membership renewal.
                            </li>
                            <li class=\"mb-3\">
                                Pay your membership on time using your credit card.
                            </li>
                            <li class=\"mb-3\">
                                Never miss your membership renewal and avoid late fees fines.
                            </li>
                        </ul>";
        $feature->type = 'image';
        $feature->save();
        ...
        $feature = new \App\Feature();
        $feature->title = 'Manage your kids sports training efficiently';
        // $feature->image = 'tools.png';
        $feature->description = '<p>We can support you wherever you are, send us support tickets and we will be happy to help.</p><ul class="list1 border-top pt-5 mt-5"><li class="mb-3">Admin can assign the tickets to respective department agents.</li></ul>';
        $feature->type = 'image';
        $feature->save();


        $feature = new \App\Feature();
        $feature->title = 'Community Centers';
        $feature->description = 'We have the best ever community. Join our one big family.';
        $feature->icon = 'fas fa-desktop';
        $feature->type = 'icon';
        $feature->save();

        $feature = new \App\Feature();
        $feature->title = 'Sport Academies';
        $feature->description = 'We offer the best ever training tracks for your kids.';
        $feature->icon = 'fas fa-wrench';
        $feature->type = 'icon';
        $feature->save();

        $feature = new \App\Feature();
        $feature->title = 'Physical Assessment';
        $feature->description = 'Keep track of physical assessment of your kids.';
        $feature->icon = 'fas fa-cubes';
        $feature->type = 'icon';
        $feature->save();

        $feature = new \App\Feature();
        $feature->title = 'Championships Management';
        $feature->description = 'Keep track of your little champions achievements.';
        $feature->icon = 'fas fa-code';
        $feature->type = 'icon';
        $feature->save();

        $feature = new \App\Feature();
        $feature->title = 'Trips Management';
        $feature->description = 'We provided a comprehensive tourism programs.';
        $feature->icon = 'far fa-file-alt';
        $feature->type = 'icon';
        $feature->save();

        $feature = new \App\Feature();
        $feature->title = 'Sports Management';
        $feature->description = "You'll freely receive attendance for your kids.";
    ...
    private function seoDetail(){
        ...
        if(count($footerPages) > 0){
            foreach($footerPages as $footerPage){
                ...
                $seoDetail->seo_keywords = 'Best sport clubs management software, web hr software, hr software online, free hr software, hr software for sme, hr management software for small business, cloud hr software, online hr management software';
                $seoDetail->seo_author = $globalSetting ? $globalSetting->company_name : 'CODAGETECH';
                $seoDetail->seo_description = 'CODAGETECH SportX saas is easy to use club management software that is designed for B2B. It include everything you need to run your businesses. like manage customers, projects, invoices, estimates, timelogs, contract and much more.';
                $seoDetail->save();
            }
        }
    }
