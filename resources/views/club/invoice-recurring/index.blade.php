...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            <a href="{{ route('club.invoices.index') }}" class="btn btn-outline btn-info btn-sm">@lang('app.menu.invoices') </a>
...
<script>
    ...
    var table = $('#invoices-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('club.invoice-recurring.create') }}',
        deferRender: true,
        "order": [[ 0, "desc" ]],
        language: {
    ...
    $(document).on('click', '.change-status', function () {
        var url = "{{route('club.invoice-recurring.changeStatus')}}";
