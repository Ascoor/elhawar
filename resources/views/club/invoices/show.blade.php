        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            <div class="col-md-12 text-right">
                ...
                <a class="btn btn-default btn-outline"
                   href="{{ route('club.invoices.download', $invoice->id) }}"> <span><i
                                ...
                                <div class="col-md-6 text-left">
                                    ...
                                    <div class="form-group">
                                        <div class="radio-list">
                                            @if($credentials->fawry_status == 'active')
                                        ...
                                        @if($credentials->fawry_status == 'active')
                                            <div class="btn-group displayNone" id="onlineBox">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    @if($credentials->fawry_status == 'active')
                                                        <li>
                                                            <a href="javascript:confirmFawryPayment('{{route('club.fawry', [$invoice->id])}}' , '{{ auth()->user()->locale }}');"><i
                                                                        class="fas fa-wallet"></i> @lang('modules.invoices.payUsingFawry') </a>
                                                        </li>
                                                    @endif
...
@if($credentials->fawry_status == 'active')
    @if($credentials->fawry_mode == 'live')
...
<script>
    ...
    @if($credentials->fawry_status == 'active')
    function confirmFawryPayment(fawry_url , locale) {
        $.easyAjax({
            type:'GET',
            url:fawry_url,
            data: '',
            success: function(res) {
                if(res.status == 'success') {
                    //console.log(res.chargeRequest);
                    checkout(res.chargeRequest , locale);
                }
            },
            error: function(res) {
    ...
    function checkout(chargeRequest , locale) {
        const configuration = {
