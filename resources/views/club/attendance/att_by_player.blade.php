...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __('app.menu.attendance') }}</h4>
        </div>
            ...
            <div class="white-box">
                <nav>
                    <ul>
                        ...
                        <li class="tab-current"><a href="{{ route('admin.attendances.AttendanceByPlayer') }}"><span>@lang('modules.club.attendanceByPlayer')</span></a>
                        </li>
...
@push('footer-script')
    ...
    <script>
        ...
        function showTable() {
            ...
            //refresh counts
            var url = '{!!  route('club.club.refreshCount', [':startDate', ':endDate', ':userId']) !!}';
            ...
            //refresh datatable
            var url2 = '{!!  route('club.club.employeeData', [':startDate', ':endDate', ':userId']) !!}';
