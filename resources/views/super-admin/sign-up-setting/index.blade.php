                                ...
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-body">
                                    ...
                                    <div class="row" style="margin-top:20px;">
                                      <div class="col-md-1">
                                          <label class="control-label">@lang('app.disable')</label>
                                        </div>
                                      <div class="col-md-1">
                                        <div class="switchery-demo">
                                            <input type="checkbox" name="registration_open" id="registration_open" 
                                                    ...
                                                    data-secondary-color="#f96262" value="true" @if($registrationStatus->registration_open == 1) checked @endif/>
                                        </div>
                                      </div>
                                      <div class="col-md-1"><label class="control-label">@lang('app.enable')</label></div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="margin-top: 20px;"></div>
                                    <div class="row disable-message" style="display: none;">
                                        <div class="tab-content">
                                            <div id="vhome3" class="tab-pane active">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                                ...
                                                                @forelse ($activeLanguages as $language)
                                                                    <li class="nav-item">
                                                                        <a 
                                                                            ...
                                                                            aria-selected="true"
                                                                        >
                                                                            <span class="flag-icon flag-icon-{{ $language->language_code == 'ar' ? 'eg' :  $language->language_code }}"></span> {{ ucfirst($language->language_name) }}
                                                                        </a>
                                                                    </li>
                                                                @empty
                                                                @endforelse
