                                ...
                                <div class="col-sm-12">
                                    <div class="white-box">
                                        ...
                                        <div class="tab-content" id="edit-form">
                                            @include('super-admin.front-faq-settings.edit-form')
                                        </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                @forelse($frontFaqs as $frontFaq)
                                                    <tr>
                                                        ...
                                                        <td>{{ $frontFaq->language ? $frontFaq->language->language_name : 'English' }}</td>
...
@push('footer-script')
  <script>
    function changeForm(target) {
        $.easyAjax({
            url: "{{ route('super-admin.faq-settings.changeForm') }}",
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('body').on('click', '#save-form', function () {
        $.easyAjax({
            ...
            file: true,
            data: {
                language_setting_id: $('#editSettings').data('language-id')
            }
        })
    });
