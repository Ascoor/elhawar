...
<div class="navbar-default sidebar" role="navigation">
                ...
                <select class="selectpicker language-switcher" data-width="fit">
                    ...
                    @foreach ($languageSettings as $language)
                        <option value="{{ $language->language_code }}" @if ($global->locale == $language->language_code) selected @endif
                            data-content='<span class="flag-icon flag-icon-{{ $language->language_code == 'ar' ? 'eg' :  $language->language_code }}"></span> {{ $language->language_code }}'>
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li><a href="{{ route('super-admin.dashboard') }}" class="waves-effect"><i
                        class="icon-speedometer fa-fw"></i> <span class="hide-menu">@lang('app.menu.dashboard')
                    </span></a> </li>

            <li><a href="{{ route('super-admin.packages.index') }}" class="waves-effect"><i
                        class="icon-calculator fa-fw"></i> <span class="hide-menu">@lang('app.menu.packages')
                    </span></a> </li>

            <li><a href="{{ route('super-admin.companies.index') }}" class="waves-effect"><i
                        class="icon-layers fa-fw"></i> <span class="hide-menu">@lang('app.menu.companies')
                    </span></a> </li>
            <li><a href="{{ route('super-admin.invoices.index') }}" class="waves-effect"><i
                        class="icon-printer fa-fw"></i> <span class="hide-menu">@lang('app.menu.invoices')
                    </span></a> </li>

            <li><a href="{{ route('super-admin.faq.index') }}" class="waves-effect"><i class="icon-docs fa-fw"></i>
                    <span class="hide-menu">@lang('app.menu.faq') </span></a> </li>
            <li><a href="{{ route('super-admin.super-admin.index') }}" class="waves-effect"><i
                        class="fa fa-user fa-fw"></i> <span class="hide-menu">@lang('app.superAdmin') </span></a>
            </li>
            <li><a href="{{ route('super-admin.offline-plan.index') }}" class="waves-effect"><i
                        class="fa fa-user-secret fa-fw"></i> <span class="hide-menu">@lang('app.offlineRequest')
                        @if ($offlineRequestCount > 0)<div class="notify notification-color"><span class="heartbit"></span><span class="point"></span></div>@endif</span> </a> </li>
            <li><a href="{{ route('super-admin.support-tickets.index') }}" class="waves-effect"><i
                        class="fa fa-ticket fa-fw"></i> <span class="hide-menu">@lang('app.supportTicket')</span>
                </a> </li>
            <li><a href="{{ route('super-admin.theme-settings') }}" class="waves-effect"><i
                        class="fa fa-cogs fa-fw"></i> <span class="hide-menu">@lang('app.front')
                        @lang('app.menu.settings') </span></a> </li>
            <li><a href="{{ route('super-admin.settings.index') }}" class="waves-effect"><i
                        class="icon-settings fa-fw"></i> <span class="hide-menu">@lang('app.menu.settings')
                    </span></a> </li>
            ...
            <div class="col-lg-6 m-b-5">
                <div class="btn-group dropup user-dropdown">
                    ...
                    <ul role="menu" class="dropdown-menu">
                        <li><a class="bg-inverse"><span
                                    class="text-white font-semi-bold">{{ ucwords($user->name) }}</span></a></li>

                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                                document.getElementById('logout-form').submit();"><i
                                    class="fa fa-power-off fa-fw"></i> @lang('app.logout')</a>
