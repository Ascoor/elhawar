...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-4 col-sm-6 col-md-7 col-xs-12 text-right bg-title-right">
            <a id="sport"
               class="btn btn-outline btn-success btn-sm">@lang('modules.members.add_new_sport') <i class="fa fa-plus"
        ...
        <form action="" id="filter-form">
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    <h5 >@lang('app.sport_code')</h5>
                    <input type="text" id="sport_code" name="sport_code" class="form-control" value="">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <h5>@lang('app.sport_name')</h5>

                    <input type="text" id="sport_name" name="sport_name" class="form-control" value="">
                </div>
            </div>

            <div class="col-md-12">
                <div class="form-group">
                    <h5>@lang('app.sport_kind')</h5>

                    <input type="text" id="sport_kind" name="sport_kind" class="form-control" value="">
                </div>
            </div>
...
@push('footer-script')
    ...
    <script>
            ...
            $('body').on('click', '.sa-params', function () {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('admin.sports_tow.destroy',':id') }}";
        ...
        $('#sport').click(function () {
            var url = '{{ route('admin.sports_tow.create')}}';
            $('#modelHeading').html('...');
            $.ajaxModal('#clientCategoryModal', url);
        });
        $('body').on('click', '.edit', function () {
            var id = $(this).data('user-id');
            var url = "{{ route('admin.sports_tow.edit',':id') }}";
            url = url.replace(':id', id);
            $('#modelHeading').html('...');
            $.ajaxModal('#clientCategoryModal', url);
        });
        ...
        $('#apply-filters').click(function () {
            $('#members-table').on('preXhr.dt', function (e, settings, data) {
                ...
                var sport_code = $('#sport_code').val();
                var sport_kind = $('#sport_Kind').val();
