    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-8 col-md-5 col-sm-6 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __($pageTitle) }}
                <span class="text-info b-l p-l-10 m-l-5">{{ $totalAssess }}</span> <span
                        class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalAssess')</span>
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-4 col-sm-6 col-md-7 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.assessments.create') }}"
               class="btn btn-outline btn-success btn-sm">@lang('app.menu.create_assessment') <i class="fa fa-plus"
        ...
        <form action="" id="filter-form">
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    <h5 >@lang('modules.club.player_membership_id')</h5>
            ...
            $('body').on('click', '.sa-params', function () {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('admin.assessments.destroy',':id') }}";
