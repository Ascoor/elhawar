    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang('app.menu.edit_assessment')</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" value="{{$assessment->name}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label >@lang('app.date')</label>
                                        <input type="text" autocomplete="off"  name="at_date" id="at_date" value="{{$assessment->at_date}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="injuries" id="injuries" value="{{$assessment->injuries}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <label>@lang('modules.club.injuries_effect')</label>
                                    <div class="form-group">
                                        <textarea name="injuries_effect" id="injuries_effect"  class="form-control summernote" rows="5">{!! $assessment->injuries_effect !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <label>@lang('modules.club.physical_assess')</label>
                                    <div class="form-group">
                                        <textarea name="physical_assess" id="physical_assess" class="form-control summernote" rows="5">{!! $assessment->physical_assessment !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <label>@lang('modules.club.skills_assess')</label>
                                    <div class="form-group">
                                        <textarea name="skills_assess" id="skills_assess" class="form-control summernote" rows="5">{!! $assessment->skills_assessment !!}</textarea>
                                    </div>
                                </div>
                            </div>
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.assessments.update', [$assessment->id])}}',
