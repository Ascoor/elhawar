                                    ...
                                    @foreach($fields as $field)
                                        <div class="col-md-3">
                                            ...
                                            <div class="mt-checkbox-inline custom-checkbox checkbox-{{$field->id}}">
                                                ...
                                                id="{{$field->name.'_'.$field->id}}" value="{{$invoice->custom_fields_data['field_'.$field->id]}}">
                                                @foreach($field->values as $key => $value)
                                                    <label class="mt-checkbox mt-checkbox-outline">
                                                        <input name="{{$field->name.'_'.$field->id}}[]" class="custom_fields_data[{{$field->name.'_'.$field->id}}]"
                                                               ...
                                                               @if($invoice->custom_fields_data['field_'.$field->id] != '' && in_array($value ,explode(', ', $invoice->custom_fields_data['field_'.$field->id]))) checked @endif > {{$value}}
                                                        <span></span>
                                                    </label>
                                                @endforeach
                                            </div>
