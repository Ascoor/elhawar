...
<div class="row dashboard-stats front-dashboard">
     {{-- /////////modificTIONS from here to next comment////////// --}}
     @if(in_array('employees',$modules) && in_array('total_new_employee',$activeWidgets))
     <div class="col-md-3 col-sm-6">
         <a href="{{ route('admin.employees.insured-employee-according-to-insurance-number-report') }}">
             <div class="white-box">
                 <div class="row">
                     <div class="col-xs-3">
                         <div><span class="bg-primary bg-gradient"><i class="icon-list"></i></span></div>
                     </div>
                     <div class="col-xs-9 text-right">
                         <span class="widget-title"> @lang('modules.dashboard.insuredEmployeeAccordingToInsuranceNumberReport')</span><br>
                     </div>
                 </div>
             </div>
         </a>
 ...
 @if(in_array('employees',$modules) && in_array('total_new_employee',$activeWidgets))
 <div class="col-md-3 col-sm-6">
     <a href="{{ route('admin.employees.account-numbers-employee-report') }}">
         <div class="white-box">
             <div class="row">
                 <div class="col-xs-3">
                     <div><span class="bg-primary bg-gradient"><i class="icon-list"></i></span></div>
                 ...
                 <div class="col-xs-9 text-right">
                     <span class="widget-title"> @lang('modules.dashboard.accountNumbersEmployeeReport')</span><br>
                 </div>
             </div>
         </div>
     </a>
 ...
 @if(in_array('employees',$modules) && in_array('total_new_employee',$activeWidgets))
 <div class="col-md-3 col-sm-6">
     <a href="javascript:;" onclick="routEmpCas()">
         <div class="white-box">
             <div class="row">
                 <div class="col-xs-3">
                     <div><span class="bg-primary bg-gradient"><i class="icon-list"></i></span></div>
                 ...
                 <div class="col-xs-9 text-right">
                     <span class="widget-title"> @lang('modules.dashboard.insuredEmployeesWithCasualLeaveBalanceReport')</span><br>
                 </div>
             </div>
         </div>
     </a>
 ...
 @if(in_array('employees',$modules) && in_array('total_new_employee',$activeWidgets))
 <div class="col-md-3 col-sm-6">
    <a href="javascript:;" onclick="routEmpUnCas()">
         <div class="white-box">
             <div class="row">
                 <div class="col-xs-3">
                     <div><span class="bg-primary bg-gradient"><i class="icon-list"></i></span></div>
                 ...
                 <div class="col-xs-9 text-right">
                     <span class="widget-title"> @lang('modules.dashboard.insuredEmployeesWithUncasualLeaveBalanceReport')</span><br>
                 </div>
             </div>
         </div>
     </a>
...
<script>
    function routEmpCas () {
        var url= "{{route('admin.employees.insured-employees-with-casual-leave-balance-report')}}";
        url=url+'/:month'+'/:year';
        var dat =moment(String(endDate),"DD-MM-YYYY");
        var month = dat.format('M');
        var year  = dat.format('YYYY');
        url = url.replace(':month', month );
        url = url.replace(':year', year );
        console.log(url)
        location.href = url;
      }
      function routEmpUnCas () {
        var url= "{{route('admin.employees.insured-employees-with-uncasual-leave-balance-report')}}";
        url=url+'/:month'+'/:year';
        var dat =moment(String(endDate),"DD-MM-YYYY");
        var month = dat.format('M');
        var year  = dat.format('YYYY');
