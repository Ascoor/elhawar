...
@section('page-title')
    ...
    {{-- @include( __DIR__.'/../../resources/views/admin/dashboard-header/dashboard_header.blade.php'); --}}
    {{-- @include( __DIR__.'/admin/dashboard-header/dashboard_header.blade.php'); --}}

    {{-- rola i removed the header name "Dashboard and time and launages," --}}
...
<script>
    ...
    //added them to dashboard_header
