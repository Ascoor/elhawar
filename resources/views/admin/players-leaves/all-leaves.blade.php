...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __($pageTitle) }} <span class="text-warning b-l p-l-10 m-l-5">{{ $pendingLeaves}}</span>  @lang('modules.leaves.pendingLeaves')</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.playersLeaves.index') }}" class="btn btn-sm btn-primary waves-effect waves-light m-l-10 btn-outline">
                <i class="fa fa-calendar"></i> @lang('modules.leaves.calendarView')
            </a>
            
            <a href="{{ route('admin.playersLeaves.create') }}" class="btn btn-sm btn-success waves-effect waves-light m-l-10 btn-outline">
...
@push('footer-script')
    ...
    <script>
        ...
        $('#leave-table').on('click', '.leave-action-reject', function () {
            ...
            var url = '{!! route('admin.playersLeaves.show-reject-modal') !!}'+searchQuery;
        ...
        $('#leave-table').on('click', '.leave-action', function() {
            var action = $(this).data('leave-action');
            var leaveId = $(this).data('leave-id');
            var url = '{{ route("admin.playersLeaves.leaveAction") }}';
        ...
        function loadTable(){
            ...
            var url = '{!!  route('admin.playersLeaves.data', [':employeeId']) !!}';
        ...
        $('body').on('click', '.show-leave', function () {
            ...
            var url = '{{ route('admin.playersLeaves.show', ':id') }}';
        ...
        {{--    window.location = '{{ route("admin.playersLeaves.pending") }}';--}}
        {{--})--}}
    </script>
@endpush