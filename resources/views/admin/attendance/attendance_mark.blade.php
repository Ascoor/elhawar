                                ...
                                <div class="form-body ">
                                    <div class="row">
                                        ...
                                        @if($row->total_clock_in == 0)
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label" >@lang('modules.attendance.permission')</label>
                                                    <div class="switchery-demo">
                                                        <input type="checkbox" name="permission" @if($row->permission == "yes") checked @endif class="js-switch change-module-setting" data-color="#ed4040" id="permission"  />
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
