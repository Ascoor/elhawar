                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-md-3">
                                    <div class="radio radio-info">
                                        <input id="employees_butt" name="user" value=""
                                               type="radio" >
                                        <label for="employees_butt">@lang('app.employees')</label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4" id="employees" style="display: none">
