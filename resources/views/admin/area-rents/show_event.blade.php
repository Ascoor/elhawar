        ...
        <div class="form-body">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="form-group">
                        <label class="control-label">@lang('modules.rentarea.hall_name')</label>
                        <p>{{ ucfirst($training->rentAreaDetails->area_name) }}</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-4 ">
                    <div class="form-group">
                        <label>@lang('modules.members.location')</label>
                        <p>{{ ucfirst($training->rentAreaDetails->location) }}</p>
                    </div>
                </div>
                <div class="col-xs-12 col-md-4 ">
                    <div class="form-group">
                        <label>@lang('modules.arearent.clientname')</label>
                        <p>{{ ucfirst($training->client_name) }}</p>
                    </div>
                </div>
                <div class="col-xs-12 col-md-4">
                    <div class="form-group">
                        <label>@lang('modules.arearent.phonenumber')</label>
                        <p>{{ ucfirst($training->phone_number) }}</p>
                    </div>
                </div>
