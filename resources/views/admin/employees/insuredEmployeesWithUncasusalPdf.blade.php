    ...
    <div class="col-md-12">
            ...
            <table class="styled-table" style="width: 100%; text-align: center; font-size: 9px">
                ...
                <tr>
                    ...
                    @endforeach<th style="border: 1px sold #3378c2; background-color: #1796c4; color:azure; font-size:4px">العارضة</th>
                ...
                <tbody style="">
                    ...
                    <tr> 
                        ...
                        <td style="border: 0.5px sold #0b0b0b; font-size:6px">{{strtr($content['irregular_leave_balance'], array('0'=>'٠','1'=>'١','2'=>'٢','3'=>'٣','4'=>'٤','5'=>'٥','6'=>'٦','7'=>'٧','8'=>'٨','9'=>'٩'))}}</td>
