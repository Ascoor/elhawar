...
<div class="row bg-title">
    ...
    <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
        <a href="{{ route('admin.employees.create') }}"
            class="btn btn-outline btn-success btn-sm">@lang('modules.employees.addNewEmployee') <i class="fa fa-plus"
    ...
    <form action="" id="filter-form">
        ...
        <div class="col-xs-12">
            <div class="form-group">
                ...
                <select class="select2 select2-multiple " multiple="multiple" data-placeholder="Choose Skills"
                    name="skill[]" id="skill" data-style="form-control">
                    <option value="all">@lang('modules.client.all')</option>
        ...
        <div class="col-xs-12">
            <div class="form-group">
                ...
                <select class="form-control select2" name="role" id="role" data-style="form-control">
                    ...
                    @if ($role->id <= 3) <option value="{{$role->id}}">{{ __('app.' . $role->name) }}</option>
                        @else
    ...
    <div class="col-md-12 m-b-30">
        <div class="white-box">
            <div class="col-sm-6 text-center">
                <h4><span class="text-info" id="total-employee">{{ $totalEmployees }}</span> <span
                        class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalEmployees')</span></h4>
            </div>
            <div class="col-sm-6 text-center b-l">
                <h4><span class="text-danger" id="free-employee">{{ $freeEmployees }}</span> <span
                        class="font-12 text-muted m-l-5"><a href="{{ route('admin.employees.freeEmployees') }}">
                            @lang('modules.dashboard.freeEmployees')</a></span></h4>
            </div>
