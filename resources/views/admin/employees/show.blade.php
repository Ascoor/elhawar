...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-sm-3 text-right">
            <a href="{{ route('admin.employees.downloadStatusInfo', $employee->id) }}" class="btn btn-success btn-sm"><i class="fa fa-download"></i> @lang('app.printStatusInfo')</a>&nbsp;
        </div>
        <!-- /.breadcrumb -->
    </div>
@endsection
    ...
    <div class="col-xs-12">
        <div class="white-box">
            <ul class="nav nav-tabs tabs customtab">
                ...
                <li class="tab"><a href="#salary" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="icon-bell"></i></span> <span class="hidden-xs">@lang('app.menu.salary')</span> </a> </li>
                <li class="tab"><a href="#deductions" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="icon-bell"></i></span> <span class="hidden-xs">@lang('app.menu.deductions')</span> </a> </li>
                <li class="tab"><a href="#sanctions" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="icon-bell"></i></span> <span class="hidden-xs">@lang('app.menu.sanctions')</span> </a> </li>
                <li class="tab"><a href="#bonuses" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="icon-bell"></i></span> <span class="hidden-xs">@lang('app.menu.bonuses')</span> </a> </li>
                <li class="tab"><a href="#grants_rewards" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="icon-bell"></i></span> <span class="hidden-xs">@lang('app.menu.grants') @lang('app.menu.rewards') @lang('app.menu.deductions2')</span> </a> </li>
                <li class="tab"><a href="#assessments" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="icon-bell"></i></span> <span class="hidden-xs">@lang('app.menu.assessments')</span> </a> </li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane" id="salary">
                    <div class="table-responsive">
                        <table class="table" style="margin-top: 10px;">
                            ...
                            <tr>
                                <th width="30%">#</th>
                                <th width="25%">@lang('app.amount')</th>
                                <th width="25%">@lang('app.type')</th>
                                <th>@lang('app.date')</th>
                            </tr>
                            </thead>
                            <tbody id="employeeDocsList">
                            @forelse($salary as $key=>$sal)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{$sal->amount}} </td>
                                    <td>{{__('app.sal.'.$sal->type)}} </td>
                                    <td>{{$sal->date}} </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4">@lang('messages.noDocsFound')</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
                ...
                <div class="tab-pane" id="deductions">
                    <div class="table-responsive">
                        <table class="table" style="margin-top: 10px;">
                            ...
                            <tbody id="employeeDocsList">
                            @forelse($deductions as $key=>$ded)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{$ded->amount}} </td>
                                    <td>{{__('app.sal.'.$ded->type)}} </td>
                                    <td>{{$ded->date}} </td>
                                </tr>
                            @empty
                                <tr>
                ...
                <div class="tab-pane" id="sanctions">
                    <div class="table-responsive">
                        <table class="table" style="margin-top: 10px;">
                            ...
                            <tr>
                                <th width="30%">#</th>
                                <th width="25%">@lang('app.penalty_type')</th>
                                <th width="25%">@lang('app.menu.penalties') @lang('app.status')</th>
                                <th>@lang('app.date')</th>
                            </tr>
                            </thead>
                            <tbody id="employeeDocsList">
                ...
                <div class="tab-pane" id="bonuses">
                    <a href="#"
                       class="btn btn-outline btn-success btn-sm">@lang('app.add')
                    ...
                    <table class="table" style="margin-top: 10px;">
                        ...
                        <tbody id="employeeDocsList">
                        @forelse($bounses as $key=>$bon)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{$bon->amount}} </td>
                                <td>{{__('app.sal.'.$bon->type)}} </td>
                                <td>{{$bon->date}} </td>
                            </tr>
                        @empty
                            <tr>
                ...
                <div class="tab-pane" id="grants_rewards">
                    <a href="#"
                       class="btn btn-outline btn-success btn-sm">@lang('app.add')
                        <i class="fa fa-edit" aria-hidden="true"></i></a>
                    <a href=""></a>
                    ...
                    <table class="table" style="margin-top: 10px;">
                        ...
                        <tr>
                            <th width="30%">#</th>
                            <th width="20%">@lang('app.type')</th>
                            <th width="20%">@lang('app.name')</th>
                        ...
                        @forelse($grants as $grn)
                            <tr>
                                <td>{{$grn['no'] }}</td>
                                <td>{{__('app.menu.'.$grn['type'])}}</td>
                                <td>{{$grn['name']}}</td>
                                <td>{{$grn['amount']}} </td>
                                <td>{{$grn['date']}} </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5">@lang('messages.noDocsFound')</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
                ...
                <div class="tab-pane" id="assessments">
                    ...
                    <div class="table-responsive">
                        <table class="table" style="margin-top: 10px;">
                            ...
                            <tr>
                                <th>#</th>
                                <th>@lang('app.menu.assessment-name-no')</th>
                                <th>@lang('app.menu.total_assessment_percentage')</th>
                                <th>@lang('app.status')</th>
                                <th>@lang('app.date')</th>
                            </tr>
                            </thead>
                            ...
                            @forelse($assessments as $key=>$ass)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$ass->name}}</td>
                                    <td>{{$ass->assessment_percentage}}%</td>
                                    <td>{{__('app.'.$ass->status)}}</td>
                                    <td>{{$ass->date}} </td>
                                </tr>
                            @empty
                                <tr>
