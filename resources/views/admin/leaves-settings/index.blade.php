    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">@lang('app.update') @lang('app.menu.leaveAndMissionsSettings')</div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="leave-type-table">
                                            <thead>
                                            <tr>
                                                <th>@lang('modules.leaves.type')</th>
                                                <th>@lang('modules.leaves.noOfDays')</th>
                                                <th>@lang('modules.leaves.paidStatus')</th>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-xs-12 ">
                                                <div class="form-group">
                                                    <label>@lang('app.add') @lang('modules.leaves.addLeaveMissionType')</label>
                                            ...
                                            <div class="col-xs-6 ">
                                                <div class="form-group">
                                                    <label>@lang('modules.leaves.noOfDays')</label>
