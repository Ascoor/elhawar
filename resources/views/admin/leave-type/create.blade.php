...
<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('app.type')</h4>
</div>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name='paid' id="paid" checked>
                        <label class="form-check-label" for="paid">@lang('modules.invoices.paid')</label>
                    </div>
                </div>
