<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('modules.members.groups')</h4>
</div>
    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <table class="table category-table">
                ...
                <tr>
                    <th>#</th>
                    <th>@lang('modules.members.groupName')</th>
                ...
                @forelse($groups as $key=>$group)
                    <tr id="cat-{{ $group->id }}">
                        ...
                        <td><a href="javascript:;" data-cat-id="{{ $group->id }}" onclick="deleteCategory({{ $group->id }})" class="btn btn-sm btn-danger btn-rounded delete-category">@lang("app.remove")</a></td>
                    </tr>
                @empty
                    <tr>
            ...
            <div class="row">
                <div class="col-xs-12 ">
                    <div class="form-group">
                        <label class="required">@lang('app.add') @lang('modules.members.groupName')</label>
...
<script>
    ...
    $('body').on('click', '.delete-category', function(e) {
        ...
        var url = "{{ route('admin.playerGroup.destroy',':id') }}";
    ...
    $('#createGroup').on('submit', (e) => {
        e.preventDefault();
        $.easyAjax({
            url: '{{route('admin.playerGroup.store')}}',
