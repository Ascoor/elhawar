...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-4 col-sm-6 col-md-7 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.sportAcademy.create') }}"
        ...
        <form action="" id="filter-form">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" id="sport_description" class="form-control summernote" rows="5"></textarea>
...
@push('footer-script')
    ...
    <script>
        ...
        $('body').on('click', '.edit', function () {
            var id = $(this).data('user-id');
            var url = "{{ route('admin.sportAcademy.edit',':id') }}";
            url = url.replace(':id', id);
            $('#modelHeading').html('...');
            $.ajaxModal('#clientCategoryModal', url);
        });
        ...
        $('#apply-filters').click(function () {
            $('#members-table').on('preXhr.dt', function (e, settings, data) {
                ...
                var sport_description = $('#sport_description').val();
