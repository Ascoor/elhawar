    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            ...
            <a href="#" data-toggle="modal" data-target="#my-event" class="btn btn-sm btn-success btn-outline waves-effect waves-light">
                <i class="ti-plus"></i> @lang('modules.club.addTrip')
            </a>
            <ol class="breadcrumb">
...
@push('footer-script')
    ...
    <script>
        ...
        var getEventDetail = function (id, start, end) {
            var url = '{{ route('admin.trips.show', ':id')}}?start='+start+'&end='+end;
        ...
        var url = '{{route('admin.trips.get-filter')}}';
        var employee = '';
        var client = '';
        var category = '';
        var event_type = '';
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: {
                url: '{{ route("admin.trips.get-filter") }}',
