    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang('app.add') @lang('app.menu.assets')</div>
                                ...
                                <div class="col-xs-12 col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="category_id" id="category_id"
                                            ...
                                            @empty
                                                <option value="">@lang('modules.assets.no_asset_cat')</option>
                                            @endforelse
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="sub_category_id" id="sub_category_id"
                                            ...
                                            @empty
                                                <option value="">@lang('modules.assets.no_asset_sub')</option>
                                            @endforelse
                                        </select>
                                    </div>
                                </div>
