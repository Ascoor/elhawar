    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('app.update') @lang('app.menu.assets')</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang('app.update') @lang('app.menu.assets')</div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {!! Form::open(['id'=>'updateProduct','class'=>'ajax-form']) !!}
                        <input name="_method" value="PUT" type="hidden">
                        <div class="form-body">
                            <h3 class="box-title">@lang('app.menu.assets') @lang('app.details')</h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-xs-12 col-md-6 ">
                                    <div class="form-group">
                                        <label class="control-label">@lang('modules.assets.asset_cat') <a href="javascript:;" id="addProjectCategory" class="text-info"><i class="ti-settings text-info"></i></a>
                                        </label>
                                ...
                                <div class="col-xs-12 col-md-6 ">
                                    <div class="form-group">
                                        <label class="control-label">@lang('modules.assets.asset_sub') <a href="javascript:;" id="addProductSubCategory" class="text-info"><i class="ti-settings text-info"></i></a>
                                        </label>
                            ...
                            <div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">@lang('modules.assets.care')</label>
                                        <select  name="care"  class="selectpicker form-control type">
                                            @foreach($employees as $employee)
                                                <option  value="{{ $employee->id }}" @if($product->care === $employee->id ) selected @endif>{{$employee->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
