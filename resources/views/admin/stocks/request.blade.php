                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div>
                                        <select  name="retrive_type"  class="form-control select2" data-placeholder="Select Product State"  data-style="form-control">
                                            <option value=""></option>
...
<script>
    ...
    $('.save-form').click(function(){
        ...
        $.easyAjax({
            url:'{{route('admin.stocks.request.store',$request_type)}}',
