                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control client-category" data-placeholder="@lang('modules.members.sport')"  id="sport_id" name="sport_id">
                                        @foreach($sports as $sport)
                                            <option value="{{ $sport->id }}" {{ $team->sport_id == $sport->id ? 'selected' : ''}}>{{ ucwords($sport->name) }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 m-b-10 select2-multiple " data-placeholder="@lang('modules.members.coach')"  id="coach_id" name="{{'coach_id[]'}}" multiple="multiple">
                                        @forelse($coaches as $coach)
                                            <option value="{{ $coach->id }}"{{in_array($coach->id , $coachesArr) ? 'selected' : ''}}>{{ ucwords($coach->user->name) }}</option>
                                        @empty
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="from_age" name="from_age" class="form-control"   value="{{$team->from_age}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="to_age" class="required">@lang('modules.members.to_age')</label>
                                    <input type="text" id="to_age" name="to_age" class="form-control"   value="{{$team->to_age}}">
                                </div>
                            </div>
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.sportsTeams.update' , $team->id)}}',
