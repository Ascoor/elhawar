    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang('modules.members.createCase')</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="case_name" name="case_name" class="form-control"   value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="national_id" class="required">@lang('modules.members.case_id')</label>
                                    <input type="text" id="case_id" name="case_id" class="form-control"   value="">
                                </div>
                            </div>
