    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang('app.menu.create_general_assembly')</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="delay_fine" id="delay_fine" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3 ">
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.assembly.store', [$user->id])}}',
