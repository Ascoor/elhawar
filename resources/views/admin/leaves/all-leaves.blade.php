...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-5 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __($pageTitle) }} <span class="text-warning b-l p-l-10 m-l-5">{{ $pendingLeaves}}</span>  @lang('modules.leaves.pendingLeavesAndMissions')</a></h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
