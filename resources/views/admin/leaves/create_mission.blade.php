...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __('app.menu.employees_missions') }}</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel ">
                <div class="panel-heading"> @lang('modules.leaves.assignMission')</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <label class="control-label">@lang('app.type')
                                            <a href="javascript:;"
                                            id="addLeaveType" class="btn btn-sm btn-outline btn-success"><i class="fa fa-plus"></i> @lang('app.add')</a>
                                        </label>
                                        <select class="selectpicker form-control" name="leave_type_id" id="leave_type_id"
                                                data-style="form-control">
                                            @forelse($leaveTypes as $leaveType)
                                                <option value="{{ $leaveType->id }}">@lang('app.'.$leaveType->type_name)</option>
                                            @empty
