...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel ">
                <div class="panel-heading"> @lang('modules.leaves.assignLeaveOrMission')</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <label style="display: none" class="control-label">@lang('modules.leaves.leaveType')
                                            <a href="javascript:;"
                                        ...
                                        <select class="selectpicker form-control" name="leave_type_id" id="leave_type_id"
                                            ...
                                            @forelse($leaveTypes as $leaveType)
                                                @if ($leaveType->type_name!='اعتيادي حديث التعيين')
