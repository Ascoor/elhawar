...
@section('page-title')
    <div class="row bg-title">
        <!-- .page title -->
        <div class="col-lg-5 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __($pageTitle) }} <span class="text-warning b-l p-l-10 m-l-5">{{ count($pendingLeaves) }}</span> @lang('modules.leaves.pendingLeavesAndMissions')</a>
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-7 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            ...
            <i class="ti-plus"></i> @lang('modules.leaves.assignLeaveOrMission')</a>
