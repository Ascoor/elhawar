                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('modules.stocks.location')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('admin.stocks.show', $inventory->id) }}"><i class="fa fa-eye"
                                            aria-hidden="true"></i></a>
                                    <a href="{{ route('admin.stocks.edit', $inventory->id) }}">
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td> <a href="{{ route('admin.items.edit', $product->id) }}">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </a></td>
                                </tr>
