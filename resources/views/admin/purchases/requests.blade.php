...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.purchases.request-create',['request_type' => 'purchase'])}}" class="btn btn-outline btn-success btn-sm"> @lang('modules.purchases.purchase_request')<i class="fa fa-plus" aria-hidden="true"></i></a>
{{--            <a href="{{ route('admin.stocks.request-create', ['request_type' => 'consumed']) }}" class="btn btn-outline btn-inverse btn-sm">Consume Request<i class="fa fa-plus" aria-hidden="true"></i></a>--}}
{{--            <a href="{{ route('admin.stocks.request-create', ['request_type' => 'retrieved']) }}" class="btn btn-outline btn-success btn-sm">Retrive Request<i class="fa fa-plus" aria-hidden="true"></i></a>--}}
{{--            <a href="{{ route('admin.stocks.request-create', ['request_type' => 'scraped']) }}" class="btn btn-outline btn-success btn-sm">Scrape Request<i class="fa fa-plus" aria-hidden="true"></i></a>--}}
...
<script>
    ...
    function printRequest(id){
        var url = '{{route('admin.purchases.printRequest')}}';
            url=url+'/:id';
            url = url.replace(':id', id );
            location.href=url;
    }
