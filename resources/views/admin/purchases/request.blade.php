    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">Create {{$request_type}} Request</div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {!! Form::open(['id'=>'storePurchaseRequest','class'=>'ajax-form','method'=>'POST']) !!}
                        <div class="form-body">
...
<script>
    ...
    function getCompanyName(){
        ...
        var url = "{{ route('admin.stocks.withdraw.get-client-company') }}";
        if(projectID != '' && projectID !== undefined )
        {
            url = "{{ route('admin.stocks.withdraw.get-client-company',':id') }}";
    ...
    $('.save-form').click(function(){
        ...
        $.easyAjax({
            url:'{{route('admin.purchases.request.store',$request_type)}}',
            container:'#storePurchaseRequest',
            type: "POST",
            redirect: true,
            data:$('#storePurchaseRequest').serialize()+ "&type=" + type
        })
    });
    ...
    $('#storePurchaseRequest').on('click','.remove-item', function () {
    ...
    $('#storePurchaseRequest').on('keyup change','.quantity,.cost_per_item,.item_name, .discount_value', function () {
    ...
    $('#storePurchaseRequest').on('change','.type, #discount_type', function () {
        var quantity = $(this).closest('.item-row').find('.quantity').val();
...
<script>
    ...
    function addProduct(id) {
        ...
        $.easyAjax({
            url:'{{ route('admin.stocks.withdraw.add-items') }}',
            type: "GET",
