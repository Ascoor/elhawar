...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
        ...
        <a href="#" data-toggle="modal" data-target="#my-event" class="btn btn-sm btn-success btn-outline waves-effect waves-light">
            <i class="ti-plus"></i> @lang('modules.club.addChamp')
        </a>
        <ol class="breadcrumb">
    ...
    <div class="modal-dialog modal-lg" id="modal-data-application">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="icon-plus"></i> @lang('modules.club.addChamp')</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="championship_name" id="championship_name" class="form-control">
                            </div>
                        </div>
...
<script>
    ...
    var getEventDetail = function (id, start, end) {
        var url = '{{ route('admin.championships.show', ':id')}}?start='+start+'&end='+end;
    ...
    var url = '{{route('admin.championships.get-filter')}}';
    var employee = '';
    var client = '';
    var category = '';
    var event_type = '';
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: {
            url: '{{ route("admin.championships.get-filter") }}',
