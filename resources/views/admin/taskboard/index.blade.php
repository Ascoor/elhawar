...
<style>
    ...
    /*}*/
    .reportrange {
        display: inline; padding-bottom: 8px !important;
    }
</style>
@endpush
...
@section('content')
    ...
    <div class="container-scroll white-box">
        <div class ="row">
            ...
            <button class="btn btn-default btn-outline btn-sm pull-right" id="my-tasks"><i class="fa fa-user"></i> 
            
                {{-- translation rola --}}
                {{-- commenting  My Tasks --}}
                @lang('app.task')
            </button>
            <button class="btn btn-default btn-outline btn-sm pull-right" id="show-all-tasks" style="display: none"><i class="fa fa-users"></i> 
                  {{-- translation rola --}}
                {{-- commenting  My Tasks --}}
                @lang('app.show_all')
            </button>
