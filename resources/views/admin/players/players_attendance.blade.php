    ...
    <div class="row">
        ...
        <div class="sttabs tabs-style-line col-md-12">
            <div class="white-box">
                <nav>
                    <ul>
                        <li class="tab-current"><a href="{{ route('admin.attendances.playersSummary') }}"><span>@lang('app.summary')</span></a>
                        </li>
                        <li><a href="{{ route('admin.attendances.AttendanceByPlayer') }}"><span>@lang('modules.club.attendanceByPlayer')</span></a>
                        </li>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label">@lang('modules.club.team')</label>
                            <select class="select2 form-control" data-placeholder="Choose team" id="team_id" name="team_id">
...
@push('footer-script')
    ...
    <script>
        ...
        function showTable() {
            ...
            //refresh counts
            var url = '{!!  route('admin.attendances.playersSummaryData') !!}';
