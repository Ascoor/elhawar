                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            value="{{ $resource->name }}" autocomplete="nope">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="form-control">
                                            ...
                                            @foreach ($resource_types as $type)
                                                <option value="{{ $type->id }}" @if ($type->id === $resource->type)
                                                    selected
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="radio radio-inline ">
                                            <input type="radio" name="borrowable" id="borrowable2" @if (!$resource->borrowable)
                                            checked
                                            @endif value="0">
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function() {
            $.easyAjax({
                url: '{{ route('admin.libraries.update', [$resource->id]) }}',
