    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            @if($user->cans('add_libraries'))
                <a href="{{ route('admin.libraries.request-create', ['request_type' => 'borrowed']) }}"
                   class="btn btn-outline btn-inverse btn-sm"> @lang('modules.libraries.borrow_resource')
                    <i class="fa fa-plus" aria-hidden="true"></i>
                </a>
                <a href="{{ route('admin.libraries.request-create', ['request_type' => 'turn_in']) }}"
                   class="btn btn-outline btn-inverse btn-sm">@lang('modules.libraries.turn_in_resource')
                    <i class="fa fa-plus" aria-hidden="true"></i>
                </a>
            @endif
            <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" name="status" id="status" data-style="form-control">
                                    ...
                                    <option value="-1"> @lang('modules.libraries.late')</option>
                                    <option value="1"> @lang('modules.libraries.turned_in')</option>
                                    <option value="0">@lang('modules.libraries.borrowed')</option>
