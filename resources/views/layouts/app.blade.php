...
<head>
    ...
    @if($rtl == 1)
    <link href="{{url('plugins/dropzone/css/dropzone-rtl.min.css')}}" rel="stylesheet" />
    @else
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="row">
            ...
            data-section" id="section-task">
                    ...
                    @if (!empty($__env->yieldContent('filter-section')) ||
                    !empty($__env->yieldContent('other-section')))
    ...
    <div class="modal fade bs-modal-md in" id="subTaskModal" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-md" id="modal-data-application">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <span class="caption-subject font-red-sunglo bold uppercase" id="subTaskModelHeading">Sub Task
                        e</span>
                </div>
                <div class="modal-body">
                    Loading...
...
<head>
    ...
    <title>@if($userRole) {{ $userRole->display_name }} @lang("app.panel") @else @lang("app.employeePanel") @endif | {{
        __($pageTitle) }}</title>
    <!-- Bootstrap Core CSS -->
    <link href="{{ asset('bootstrap/dist/css/bootstrap.min.css') }}" rel="stylesheet">
    <link rel='stylesheet prefetch'
    ...
    <style>
        :root {
            ...
            --sidebar_text_color: {
                    {
                    $employeeTheme->sidebar_text_color
                }
            }
