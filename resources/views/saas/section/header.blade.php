    ...
    <div class="banner position-relative">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-12 d-lg-block wow zoomIn" data-wow-delay="0.3s">
                    <div class="banner-img shadow1">
                        <img src="{{ $trFrontDetail->image_url ?: $defaultTrFrontDetail->image_url }}" alt="business" class="shadow1" style="border-radius: 5px;">
                    </div>
                </div>
            </div>
        </div>
