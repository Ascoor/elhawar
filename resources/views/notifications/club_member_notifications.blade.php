...
@forelse ($user->unreadNotifications as $notification)
    @if(view()->exists('notifications.club.'.\Illuminate\Support\Str::snake(class_basename($notification->type))))
        @include('notifications.club.'.\Illuminate\Support\Str::snake(class_basename($notification->type)))
    @endif
@empty
