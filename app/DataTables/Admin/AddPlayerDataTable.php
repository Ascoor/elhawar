...
class AddPlayerDataTable extends BaseDataTable
{
    /**
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                $action = '<div class="btn-group dropdown m-r-10">
                 <a href="' . route('admin.sportsTeams.addPlayer', ['id'=>$row->id, 'team_id'=>$this->this_team]) . '" class="btn btn-default  waves-effect waves-light" type="button"><i class="fa fa-plus "></i></a>
                </div>';
...
//            ->join('sports_teams' , 'member_details.team_id' , '=' , 'sports_teams.id')
            ...
            ->select('member_details.id' , 'member_details.member_id' , 'member_details.user_id', 'member_details.name',  'member_details.email', 'member_details.created_at',
                'member_details.phone' , 'member_details.category_id' , 'member_details.family_id' , 'member_category.category_name' , 'member_status.status_name' , 'member_relations.relation_name' , 'member_details.team_id')
            ->where('player' , 1)
