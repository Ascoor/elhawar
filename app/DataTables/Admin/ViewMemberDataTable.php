...
class ViewMemberDataTable extends BaseDataTable
{
    /**
    ...
    public function query(memberDetails $model)
    {
        ...
        $family_id=$model->where('member_details.id' , $request->member)->first()->family_id;
        $model = $model->where('family_id' , $family_id)
            ...
            ->select('member_details.id' , 'member_details.member_id', 'member_details.user_id', 'member_details.name',  'member_details.email', 'member_details.created_at',
                'member_details.phone' , 'member_details.category_id' , 'member_details.family_id' , 'member_category.category_name' , 'member_status.status_name' , 'member_relations.relation_name', 'excluded_categories.name as exc_cat')
