...
class ProductsDataTable extends BaseDataTable
{
     ...
     */
    public function query(EngineeringProduct $model)
    {
        $request = $this->request();

        $model =  $model->join('users','engineering_products.care','users.id')->select('engineering_products.*','users.name as care');
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            __('modules.assets.care')  => ['data' => 'care', 'name' => 'care'],
