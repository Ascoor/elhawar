...
class UpdateGatewayCredentials extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'sandbox_merchant_code' => 'required',
            'sandbox_merchant_hash' => 'required',
            'sandbox_plugin_url' => 'required',
            'live_merchant_code' => 'required',
            'live_merchant_hash' => 'required',
            'live_plugin_url' => 'required',
            'fawry_mode' => 'required',
            'fawry_status' => 'required',
        ];
    }
}
