...
class ClubInvoicesRecurringController extends ClubBaseController
{
    ...
    {
        return view('club.invoice-recurring.index', $this->data);
    }
...
//            ->where('invoice_recurring.status', 'active');
        ...
        return DataTables::of($invoices)
            ->addColumn('action', function ($row) {
                return '<a href="' . route('club.invoice-recurring.show', $row->id) . '" data-toggle="tooltip" data-original-title="View" class="btn  btn-sm btn-outline btn-info"><i class="fa fa-search"></i> '.__('app.view').'</a>';
            })
    ...
    public function show($id)
    {
        ...
        return view('club.invoice-recurring.show', $this->data);
    }
    ...
    public function invoice($id)
    {
        $this->invoice = RecurringInvoice::with('recurrings')
            ...
            ->findOrFail($id);
        return view('club.invoice-recurring.recurring-invoices', $this->data);
    }
