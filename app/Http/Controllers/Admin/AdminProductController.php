...
class AdminProductController extends AdminBaseController
{
    ...
    {
        $this->totalProducts = EngineeringProduct::count();
    ...
    {
        $products = new EngineeringProduct();
        ...
        $products->care = $request->care ??  null;
        $products->save();
    ...
    {
        $this->product = EngineeringProduct::find($id);
        $this->taxes = Tax::all();
        $this->categories = EngineeringProductCategory::all();
        $this->subCategories = EngineeringProductSubCategory::all();
        $this->invoiceSetting = InvoiceSetting::first();
    ...
    {
        $products = EngineeringProduct::find($id);
        $products->name = $request->name;
        $products->price = $request->price;
        $products->hsn_sac_code = $request->hsn_sac_code;
        $products->taxes = $request->tax ? json_encode($request->tax) : null;
    ...
    {
        EngineeringProduct::destroy($id);
        return Reply::success(__('messages.productDeleted'));
    }
   
    public function export() {
        $attributes =  ['tax', 'taxes', 'price'];
        $products = EngineeringProduct::select('id', 'name', 'price')
    ...
    public function getSubcategory(Request $request){
        ...
        $this->subcategories = EngineeringProductSubCategory::where('category_id', $request->cat_id)->get();
