...
//    }
    ...
    {
        $this->pageTitle = 'app.menu.memberDashboard';

        $this->fromDate = Carbon::now()->timezone($this->global->timezone)->subDays(30)->toDateString();
        $this->toDate = Carbon::now()->timezone($this->global->timezone)->toDateString();
        $this->widgets = DashboardWidget::where('dashboard_type', 'admin-member-dashboard')->get();
        $this->activeWidgets = DashboardWidget::where('dashboard_type', 'admin-member-dashboard')->where('status', 1)->get()->pluck('widget_name')->toArray();
        if (request()->ajax()) {
            $this->totalWorkingMemberFemaleMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.gender', 'female')
                ->where('member_details.category_id', 1)
                ->select('users.id')
                ->get()->count();
             $this->totalWorkingMemberMaleMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.gender', 'male')
                 ->where('member_details.category_id', 1)
                ->select('users.id')
                ->get()->count();
            $this->totalAffiliateMemberFemaleMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.gender', 'female')
                ->where('member_details.category_id', 2)
                ->select('users.id')
                ->get()->count();
            $this->totalAffiliateMemberMaleMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ...
                ->select('users.id')
                ->get()->count();
            $this->totalFoundingMemberFemaleMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.gender', 'female')
                ->where('member_details.category_id', 3)
                ->select('users.id')
                ->get()->count();
            $this->totalFoundingMemberMaleMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ...
                ->select('users.id')
                ->get()->count();
            $this->totalHonoraryMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.category_id', 4)
                ->select('users.id')
                ->get()->count();
            $this->totalSeasonalMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.category_id', 5)
                ->select('users.id')
                ->get()->count();
            $this->totalAthleticMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.category_id', 6)
                ->select('users.id')
                ->get()->count();
            $this->totalSonsOver25Members = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.status_id', 5)
                ->select('users.id')
                ->get()->count();
            $this->totalDroppedAffiliatedMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ...
                ->select('users.id')
                ->get()->count();
            $this->totalActiveMemberMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.status_id', 1)
                ->select('users.id')
                ->get()->count();
            $this->totalDroppedMainMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ...
                ->select('users.id')
                ->get()->count();
            $this->totalDeadMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.status_id', 6)
                ->select('users.id')
                ->get()->count();
            $this->totalPaidMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.status_id', 7)
                ->select('users.id')
                ->get()->count();
            $this->totalUnpaidMembers = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.status_id', 8)
                ->select('users.id')
                ->get()->count();
/////////////////chart


            $Police = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.excluded_categories_id', 2)
                ->get()->count();
            $Judges = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.excluded_categories_id', 3)
                ->get()->count();
            $Journalists = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.excluded_categories_id', 4)
                ->get()->count();
            $WarriorForces = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.excluded_categories_id', 5)
                ->get()->count();
            $SportsAffairs = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.excluded_categories_id', 6)
                ->get()->count();
            $ArmedForces = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.excluded_categories_id', 7)
                ->get()->count();
            $PeopleWithNeeds = User::withoutGlobalScope('active')
                ->join('role_user', 'role_user.user_id', '=', 'users.id')
                ->join('roles', 'roles.id', '=', 'role_user.role_id')
                ->leftJoin('member_details', 'users.id', '=', 'member_details.user_id')
                ->where('roles.name', 'member')
                ->where('member_details.excluded_categories_id', 8)
                ->get()->count();

            $chartData =[
                ['name'=>__('app.police'),'count'=>$Police?$Police:0],
                ['name'=>__('app.judges'),'count'=>$Judges?$Judges:0],
                ['name'=>__('app.journalists'),'count'=>$Journalists?$Journalists:0],
                ['name'=>__('app.warrior_forces'),'count'=>$WarriorForces?$WarriorForces:0],
                ['name'=>__('app.sports_affairs'),'count'=>$SportsAffairs?$SportsAffairs:0],
                ['name'=>__('app.armed_forces'),'count'=>$ArmedForces?$ArmedForces:0],
                ['name'=>__('app.people_with_needs'),'count'=>$PeopleWithNeeds?$PeopleWithNeeds:0],
            ];
            $this->chartData = json_encode($chartData);
            $view = view('admin.dashboard.member-dashboard', $this->data)->render();
            //return Reply::success($this->chartData);
            return Reply::dataOnly(['view' => $view]);
        }
        return view('admin.dashboard.member', $this->data);
    }
    ...
    public function projectDashboard(Request $request)
    {
        ...
        if (request()->ajax()) {
            ...
            $this->totalProject = Project::whereBetween(DB::raw('DATE(`start_date`)'), [$this->fromDate, $this->toDate])
                ->get()->count();
