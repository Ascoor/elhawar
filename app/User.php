...
class User extends BaseModel implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope('active', function (Builder $builder) {
            $builder->where('users.status', '=', 'active')->orWhere('users.status', '=', 'deactive');
        });
    ...
    //rola
    public function dailyRecordsEntrieEmployee()
    {
        return $this->hasMany(DailyRecordsEntrie::class, 'users','id');
    }
    ...
    {
        return $this->hasMany(memberDetails::class, 'user_id');
    }
    ...
    {
        return $this->hasMany(Assessment::class, 'player_id', 'assess_id');
    }
    ...
    {
        return $this->belongsToMany(SportSession::class, 'session_member', 'user_id', 'session_id');
        //            ->withPivot('level_id' , 'group_id' , 'coach_id' , 'capacity' , 'fees' ,'training_days' , 'start_time' ,'end_time');
    }
    public function assemblies()
    {
        return $this->belongsToMany(GeneralAssembly::class, 'assembly_attendees', 'user_id', 'assembly_id');
    }
    public function penalties()
    {
        return $this->belongsToMany(Penalties::class, 'penalty_user', 'user_id', 'penalty_id');
    }
    ...
    public function getModulesAttribute()
    {
        ...
        if ($user) {
            ...
            if ($user->hasRole('member')) {
                $module = $module->where('type', 'member');
            }
