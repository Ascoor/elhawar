...
Route::group(
    ...
    function () {
        ...
        Route::get('fawry/{invoiceId}', array('as' => 'fawry', 'uses' => 'FawryController@paymentWithFawry',));
        Route::get('fawryPaymentReturn', array('as' => 'fawryPaymentReturn', 'uses' => 'FawryController@fawryPaymentReturn',));
...
Route::group(['middleware' => 'auth'], function () {
    ...
    //sportx routes
    Route::group(
        ['namespace' => 'Club', 'prefix' => 'club', 'as' => 'club.', 'middleware' => ['role:member']],
        function () {
            Route::get('fawry/{invoiceId}', array('as' => 'fawry', 'uses' => 'FawryController@paymentWithFawry',));
            Route::get('fawryPaymentReturn', array('as' => 'fawryPaymentReturn', 'uses' => 'FawryController@fawryPaymentReturn',));

            Route::get('dashboard', ['uses' => 'ClubDashboardController@index'])->name('dashboard');
            Route::get('club/get-family-sessions', ['uses' => 'ClubMemberController@familySportEventFilter'])->name('club.get-family-sessions');
            Route::get('club/get-sessions', ['uses' => 'ClubMemberController@mySportEventFilter'])->name('club.get-sessions');
            Route::get('club/get-filter', ['uses' => 'ClubMemberController@sportEventFilter'])->name('club.get-filter');
            Route::get('club/subscribe/{id}', ['uses' => 'ClubMemberController@subscribe'])->name('club.subscribe');
            Route::get('club/familySessions', ['uses' => 'ClubMemberController@familySessions'])->name('club.familySessions');
            Route::get('club/mySessions', ['uses' => 'ClubMemberController@mySessions'])->name('club.mySessions');
            Route::get('club/familyMembers', ['uses' => 'ClubMemberController@familyMembers'])->name('club.familyMembers');
            Route::get('trips/get-filter', ['uses' => 'ClubTripController@sportEventFilter'])->name('trips.get-filter');
            Route::get('trips/get-family-sessions', ['uses' => 'ClubTripController@familySportEventFilter'])->name('trips.get-family-sessions');
            Route::get('trips/get-sessions', ['uses' => 'ClubTripController@mySportEventFilter'])->name('trips.get-sessions');
            Route::get('trips/subscribe/{id}', ['uses' => 'ClubTripController@subscribe'])->name('trips.subscribe');
            Route::get('trips/familySessions', ['uses' => 'ClubTripController@familySessions'])->name('trips.familySessions');
            Route::get('trips/mySessions', ['uses' => 'ClubTripController@mySessions'])->name('trips.mySessions');
            Route::get('championships/get-filter', ['uses' => 'ClubChampionshipsController@championshipsFilter'])->name('championships.get-filter');
            Route::get('club/familyAttendanceByPlayer', ['uses' => 'ClubMemberController@familyAttendanceByPlayer'])->name('club.familyAttendanceByPlayer');
            Route::get('club/employeeData/{startDate?}/{endDate?}/{userId?}', ['uses' => 'ClubMemberController@employeeData'])->name('club.employeeData');
            Route::get('club/refresh-count/{startDate?}/{endDate?}/{userId?}', ['uses' => 'ClubMemberController@refreshCount'])->name('club.refreshCount');

            Route::resource('championships' , 'ClubChampionshipsController');
            Route::resource('club' , 'ClubMemberController');
            Route::resource('trips' , 'ClubTripController');

            Route::get('language/change-language', ['uses' => 'ClubMemberProfileController@changeLanguage'])->name('language.change-language');
            Route::resource('profile', 'ClubMemberProfileController');

            // Invoice Section
            Route::post('invoices/stripe-modal/', ['uses' => 'ClubInvoicesController@stripeModal'])->name('invoices.stripe-modal');
            Route::get('invoices/payfast-success', ['uses' => 'ClubInvoicesController@payfastSuccess'])->name('invoices.payfast-success');
            Route::get('invoices/payfast-cancel', ['uses' => 'ClubInvoicesController@payfastCancel'])->name('invoices.payfast-cancel');

            Route::get('invoices/download/{id}', ['uses' => 'ClubInvoicesController@download'])->name('invoices.download');
            Route::get('invoices/offline-payment', 'ClubInvoicesController@offlinePayment')->name('invoices.offline-payment');
            Route::post('invoices/offline-payment-submit', 'ClubInvoicesController@offlinePaymentSubmit')->name('invoices.offline-payment-submit');

            Route::resource('invoices', 'ClubInvoicesController');

            //Invoice recurring
            Route::post('invoice-recurring/change-status', ['uses' => 'ClubInvoicesRecurringController@changeStatus'])->name('invoice-recurring.changeStatus');
            Route::get('invoice-recurring/export/{startDate}/{endDate}/{status}/{employee}', ['uses' => 'ClubInvoicesRecurringController@export'])->name('invoice-recurring.export');
            Route::get('invoice-recurring/invoice/{id}', ['uses' => 'ClubInvoicesRecurringController@invoice'])->name('invoice-recurring.invoice');
            Route::get('invoice-recurring/recurring-invoice/{id}', ['uses' => 'ClubInvoicesRecurringController@recurringInvoice'])->name('invoice-recurring.recurring-invoice');
            Route::resource('invoice-recurring', 'ClubInvoicesRecurringController');

            //Payments section
            Route::get('payments/data', ['uses' => 'ClubPaymentController@data'])->name('payments.data');
            Route::resource('payments', 'ClubPaymentController');
            // teams routes
            Route::get('training/get-filter', ['uses' => 'ClubTeamsCalenderController@trainingsFilter'])->name('training.get-filter');

            Route::resource('location', 'ClubLocationController');
            Route::resource('sport', 'ClubSportsController');
            Route::resource('team', 'ClubTeamsController');
            Route::resource('training', 'ClubTeamsCalenderController');

            //notice board
            Route::get('notices/data', ['uses' => 'ClubNoticeController@data'])->name('notices.data');
            Route::resource('notice', 'ClubNoticeController');
    ...
    Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'],function (){
        // Stocks
        Route::group(
            ['namespace' => 'Stocks'],function(){
                Route::resource('stocks', 'StockController');
                Route::resource('categories', 'CategoryController');
                Route::resource('items', 'ProductController');
                Route::resource('transactions','TransactionsController');

                Route::get('/stocks/create/{request_type}/request',"ManageStocksController@Request")->name('stocks.request-create');
                Route::post('/stocks/store/{request_type}/request',"ManageStocksController@saveRequest")->name('stocks.request.store');
                Route::get('/stocks/create/add-items',"ManageStocksController@addItems")->name('stocks.withdraw.add-items');
                Route::get('stocks/create/update-item', ['uses' => 'ManageStocksController@addItems'])->name('stocks.withdraw.update-item');
                Route::get('stocks/create/payment-detail/{invoiceID}', ['uses' => 'ManageStocksController@paymentDetail'])->name('stocks.withdraw.payment-detail');
                Route::get('stocks/create/get-client-company/{projectID?}', ['uses' => 'ManageStocksController@getClientOrCompanyName'])->name('stocks.withdraw.get-client-company');
                Route::post('/stocks/move-products/{id}','StockController@moveProducts' )->name('stocks.move-products');
                Route::get('/stocks/requests/show','ManageStocksController@index')->name('stocks.show-requests');
                Route::get('stocks/requests-approve/{request_type}/{id}',['uses' => 'ManageStocksController@approveRequest'])->name('stocks.approve-request');


        });
        //libraries
        Route::group(
            ['namespace' => 'Libraries'],function(){
            Route::resource('/libraries', 'LibraryController');
            Route::get('/libraries/create/{request_type}/request',"LibraryController@Request")->name('libraries.request-create');
            Route::post('/libraries/store/{request_type}/request',"LibraryController@saveRequest")->name('libraries.request.store');
            Route::get('/libraries/requests/show','LibraryController@showRequests')->name('libraries.show-requests');
        });
        //archives
        Route::group(
            ['namespace' => 'Orders'],function(){
            Route::resource('/orders', 'OrdersController');
            Route::get('/orders/{order}/reply', 'OrdersController@reply')->name('orders.reply');
            Route::post('/orders/{order}/store-reply', 'OrdersController@storeReply')->name('orders.store-reply');
            Route::get('/orders/{order}/survey', 'OrdersController@survey')->name('orders.survey');
            Route::post('/orders/{order}/vote', 'OrdersController@vote')->name('orders.vote');
        });
        // Purchases
        Route::group(
            ['namespace' => 'Purchases'],
            function () {
                Route::get('/purchases/create/{request_type}/request',"ManagePurchasesController@Request")->name('purchases.request-create');
                Route::post('/purchases/store/{request_type}/request',"ManagePurchasesController@saveRequest")->name('purchases.request.store');
                Route::get('/purchases/create/add-items',"ManagePurchasesController@addItems")->name('purchases.withdraw.add-items');
                Route::get('purchases/create/update-item', ['uses' => 'ManagePurchasesController@addItems'])->name('purchases.withdraw.update-item');
                Route::get('purchases/create/payment-detail/{invoiceID}', ['uses' => 'ManagePurchasesController@paymentDetail'])->name('purchases.withdraw.payment-detail');
                Route::get('purchases/create/get-client-company/{projectID?}', ['uses' => 'ManagePurchasesController@getClientOrCompanyName'])->name('purchases.withdraw.get-client-company');
                Route::post('/purchases/move-products/{id}','PurchasesController@moveProducts' )->name('purchases.move-products');
                Route::get('/purchases/requests/show','ManagePurchasesController@index')->name('purchases.show-requests');
                Route::get('purchases/requests-approve/{id}',['uses' => 'ManagePurchasesController@approveRequest'])->name('purchases.approve-request');
                Route::get('purchases/requests-disapprove/{id}',['uses' => 'ManagePurchasesController@disApproveRequest'])->name('purchases.disapprove-request');
                Route::get('purchases/requests-printRequest/{id?}', ['uses' => 'ManagePurchasesController@printRequest'])->name('purchases.printRequest');
            }
        );

        //members routes
        Route::get('members/createToFamily/{clientID?}' , ['uses' => 'ManageMembersController@createToFamily'])->name('members.createToFamily');
        Route::get('members/membership-renew' , ['uses' => 'ManageMembersController@membershipRenew'])->name('members.membership-renew');
        Route::get('members/create-recurring-invoice' , ['uses' => 'ManageMembersController@membershipRenewCreate'])->name('members.create-recurring-invoice');
        Route::post('members/membership-renew-store' , ['uses' => 'ManageMembersController@membershipRenewStore'])->name('members.membership-renew-store');
        Route::get('members/membership-renew-edit/{id}' , ['uses' => 'ManageMembersController@membershipRenewEdit'])->name('members.membership-renew-edit');
        Route::put('members/membership-renew-update/{id}' , ['uses' => 'ManageMembersController@membershipRenewUpdate'])->name('members.membership-renew-update');
        Route::delete('members/membership-renew-delete/{id}' , ['uses' => 'ManageMembersController@membershipRenewDelete'])->name('members.membership-renew-delete');
        Route::get('members/membership-renew-show/{id}' , ['uses' => 'ManageMembersController@membershipRenewShow'])->name('members.membership-renew-show');
        Route::get('members/renew-settings' , ['uses' => 'ManageMembersController@membershipRenewSettings'])->name('members.renew-settings');
        Route::post('members/update-renew-settings' , ['uses' => 'ManageMembersController@updateRenewSettings'])->name('members.update-renew-settings');
        Route::get('members/addToFamily' , ['uses' => 'ManageMembersController@add_to_family'])->name('members.add_to_family');
        Route::get('members/families' , ['uses' => 'ManageMembersController@FamilyIndex'])->name('members.family_index');
        Route::get('members/data/{employeeId?}' , ['uses' => 'ManageMembersController@data'])->name('members.data');
        Route::get('members/penalties' , ['uses' => 'ManageMembersController@membersPenalties'])->name('members.penalties');
        Route::post('members/penaltyAction', ['as' => 'members.penaltyAction', 'uses' => 'ManageMembersController@penaltyAction']);
        Route::get('members/show-reject-modal', ['as' => 'members.show-reject-modal', 'uses' => 'ManageMembersController@rejectModal']);
        Route::get('members/show-penalty/{id}', ['as' => 'members.show-penalty', 'uses' => 'ManageMembersController@showPenalty']);
        Route::get('members/edit-penalty/{id}', ['as' => 'members.edit-penalty', 'uses' => 'ManageMembersController@editPenalty']);
        Route::get('members/delete-penalty/{id}', ['as' => 'members.delete-penalty', 'uses' => 'ManageMembersController@deletePenalty']);
        Route::get('members/update-penalty/{id}', ['as' => 'members.update-penalty', 'uses' => 'ManageMembersController@updatePenalty']);
        Route::get('members/invoices' , ['uses' => 'ManageMembersController@invoiceInex'])->name('members.invoices');
        Route::get('members/invoices/create' , ['uses' => 'ManageMembersController@invoiceCreate'])->name('members.invoicesCreate');
        Route::get('members/invoices/store' , ['uses' => 'ManageMembersController@invoiceStore'])->name('members.invoicesStore');



//          Route::get('club/subscribe/{id}', ['uses' => 'ClubMemberController@subscribe'])->name('club.subscribe');
          Route::get('club/subscribe/{id}/{subscriber_id?}', ['uses' => 'ClubMemberController@subscribe'])->name('club.subscribe');
          Route::get('members/search/members/{key}', ['uses'=>'ManageMembersController@searchMember'])->name('members.search-member');
          Route::get('/select-user/{display_category}',['uses'=> 'ManageMembersController@selectUser'])->name('members.select-user');
          Route::get('/select-client-member/{display_category}',['uses'=> 'ManageMembersController@selectClientMember'])->name('members.select-client-member');


          Route::resource('memberRelation', 'MemberRelationController');
          Route::resource('memberStatus', 'MemberStatusController');
          Route::get('members/dashboardIndex/{par}' , ['uses' => 'ManageMembersController@dashboardIndex'])->name('members.dashboardIndex');
          Route::resource('members', 'ManageMembersController');
          Route::resource('memberCategory', 'MemberCategoryController');
          //import
          Route::post('members/file-import', ['uses' =>'ManageMembersController@Import'])->name('members.file-import');
          //sport academies routes
          Route::get('sportActivity/get-filter', ['uses' => 'SportActivityController@sportEventFilter'])->name('sportActivity.get-filter');
          Route::resource('sportAcademy', 'SportAcademyController');
          Route::resource('sportActivity', 'SportActivityController');
          Route::resource('level', 'LevelController');
          Route::resource('location', 'LocationController');
          Route::resource('playerGroup', 'PlayerGroupController');
          //players routes
          Route::get('assessments/createAssess/{user_id}', ['uses' => 'AssessmentController@createAssess'])->name('assessments.createAssess');

          Route::get('players/redirectToEdit/{member_id}', ['uses' => 'ManagePlayersController@redirectToEdit'])->name('players.redirectToEdit');
          Route::get('players/createFromMember', ['uses' => 'ManagePlayersController@createFromMember'])->name('players.createFromMember');
          Route::resource('players', 'ManagePlayersController');
          Route::resource('assessments', 'AssessmentController');

          // players attendance routes
          Route::get('attendances/playersSummary', ['uses' => 'ManageAttendanceController@playersSummary'])->name('attendances.playersSummary');
          Route::post('attendances/playersSummaryData', ['uses' => 'ManageAttendanceController@playersSummaryData'])->name('attendances.playersSummaryData');
          Route::get('attendances/AttendanceByPlayer', ['uses' => 'ManageAttendanceController@AttendanceByPlayer'])->name('attendances.AttendanceByPlayer');
          //players leaves routes
          Route::post('playersLeaves/leaveAction', ['as' => 'playersLeaves.leaveAction', 'uses' => 'ManagePlayersLeavesController@leaveAction']);
          Route::get('playersLeaves/show-reject-modal', ['as' => 'playersLeaves.show-reject-modal', 'uses' => 'ManagePlayersLeavesController@rejectModal']);
          Route::post('playersLeaves/data/{employeeId?}', ['uses' => 'ManagePlayersLeavesController@data'])->name('playersLeaves.data');
          Route::get('playersLeaves/all-leaves', ['uses' => 'ManagePlayersLeavesController@allLeave'])->name('playersLeaves.all-leaves');
//          Route::get('playersLeaves/pending', ['as' => 'playersLeaves.pending', 'uses' => 'ManagePlayersLeavesController@pendingLeaves']);

          Route::resource('playersLeaves', 'ManagePlayersLeavesController');
          //sports routes
          Route::get('sportsTeams/removePlayer/{id}/{team_id}', ['uses' => 'SportsTeamsController@removePlayer'])->name('sportsTeams.removePlayer');
          Route::get('sportsTeams/teamPlayers/{team_id}', ['uses' => 'SportsTeamsController@teamPlayers'])->name('sportsTeams.teamPlayers');

          Route::get('sportsTeams/addPlayer/{id}/{team_id}', ['uses' => 'SportsTeamsController@addPlayer'])->name('sportsTeams.addPlayer');
          Route::get('sportsTeams/addPlayerIndex/{team_id}', ['uses' => 'SportsTeamsController@addPlayerIndex'])->name('sportsTeams.addPlayerIndex');
          Route::get('championships/get-filter', ['uses' => 'ChampionshipsController@championshipsFilter'])->name('championships.get-filter');
          Route::get('training/get-filter', ['uses' => 'TeamsTrainingsController@trainingsFilter'])->name('training.get-filter');
          Route::resource('sports', 'SportsController');
          Route::resource('sportsTeams', 'SportsTeamsController');
          Route::resource('championships', 'ChampionshipsController');
          Route::resource('training', 'TeamsTrainingsController');

          //trips routes
          Route::get('trips/get-filter', ['uses' => 'TripsController@tripFilter'])->name('trips.get-filter');

          Route::resource('trips', 'TripsController');

          //penalties
          Route::get('penalties/data/{employeeId?}' , ['uses' => 'PenaltiesController@data'])->name('penalties.data');
          Route::get('penalties/create-employee-penalty', 'PenaltiesController@createEmployeePenalty')->name('penalties.create-employee-penalty');
          Route::post('penalties/store-employee-penalty', 'PenaltiesController@storeEmployeePenalty')->name('penalties.store-employee-penalty');
          ...
          //general assembly
          Route::get('assemblyAttendees/attendanceIndex/{assembly_id}', ['uses' => 'AssemblyAttendeesController@attendanceIndex'])->name('assemblyAttendees.attendanceIndex');
          Route::get('assemblyAttendees/applyFine/{assembly_id}', ['uses' => 'AssemblyAttendeesController@applyFine'])->name('assemblyAttendees.applyFine');
          Route::get('assemblyAttendees/addAttendee/{id}/{assembly_id?}', ['uses' => 'AssemblyAttendeesController@addAttendee'])->name('assemblyAttendees.addAttendee');

          Route::resource('assembly', 'GeneralAssemblyController');
          Route::resource('assemblyAttendees', 'AssemblyAttendeesController');



        Route::resource('subscribers', 'SessionSubscribersController');
        Route::resource('tripSubscribers', 'TripsSubscribersController');
        //rola
        //area rent
        // Route::resource('areaRent', ['uses' => 'AreaRentController'])->name('area-rents');
        // Route::resource('areaRent', 'AreaRentController')->name('area-rents');
        // Route::get('clients/{client}/users', [ClientController::class, 'users'])->name('clients.users.index');

        // Route::get('articles/trending', [App\Http\Controllers\Admin\AreaRentController::class, 'calender'])->name('calender');
        Route::get('areaRent/calender', 'AreaRentController@calender')->name('calender');
        Route::get('areaRent/calenderFilter', 'AreaRentController@CalenderFilter')->name('area-rents.get-filter');

        // area-rents.get-filter
        Route::resource('areaRent', 'AreaRentController', ['names' => 'area-rents']);
        // Route::post('areaRent/r', 'AreaRentController@inputvalue')->name('area-rents.input');
        // Route::get('areaRent/r', 'App\Http\Controllers\Admin\AreaRentController@calender')->name('calender');
        // calender
        // Route::get('areaRent/r', 'App\Http\Controllers\AdminAreaRentController@calender')->name('calender');
    ...
    // Admin routes
    Route::group(
        ['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['role:employee,member']],
        function () {
            ...
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::get('/member-dashboard', 'AdminDashboardController@memberDashboard')->name('memberDashboard');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::get('employees/downloadStatusInfo/{id}', ['uses' => 'ManageEmployeesController@downloadStatusInfo'])->name('employees.downloadStatusInfo');
                        Route::post('employees/leaveTypeUpdate/{id}', ['uses' => 'ManageEmployeesController@leaveTypeUpdate'])->name('employees.leaveTypeUpdate');
                        Route::get('employees/employees-assessment-setting', 'ManageEmployeesController@EmployeesAssessmentSetting')->name('employees.employees-assessment-setting');
                        Route::get('employees/insured-employee-according-to-insurance-number-report', 'ManageEmployeesController@insuredEmployeeAccordingToInsuranceNumberReport')->name('employees.insured-employee-according-to-insurance-number-report');
                        Route::get('employees/account-numbers-employee-report', 'ManageEmployeesController@accountNumbersEmployeeReport')->name('employees.account-numbers-employee-report');
                        Route::get('employees/insured-employees-with-uncasual-leave-balance-report/{month?}/{year?}', 'ManageEmployeesController@insuredEmployeesWithUncasualLeaveBalanceReport')->name('employees.insured-employees-with-uncasual-leave-balance-report');
                        Route::get('employees/insured-employees-with-casual-leave-balance-report/{month?}/{year?}', 'ManageEmployeesController@insuredEmployeesWithCasualLeaveBalanceReport')->name('employees.insured-employees-with-casual-leave-balance-report');
                        Route::post('employees/store-employee-settings', 'ManageEmployeesController@storeEmployeeSettings')->name('employees.store-employee-settings');
                        Route::resource('employees', 'ManageEmployeesController');
                        Route::post('employees/media', 'ManageEmployeesController@storeMedia')->name('employees.storeMedia');
                        Route::get('employees/assessment/index', 'EmployeesAssessmentController@index')->name('employees.assessments.index');
                        Route::delete('employees/assessment/destroy/{id}', 'EmployeesAssessmentController@destroy')->name('employees.assessments.destroy');
                        Route::get('employees/assessment/edit/{id}', 'EmployeesAssessmentController@edit')->name('employees.assessments.edit');
                        Route::post('employees/assessment/update/{id}', 'EmployeesAssessmentController@update')->name('employees.assessments.update');
                        Route::get('employees/assessment/create', 'EmployeesAssessmentController@create')->name('employees.assessments.create');
                        Route::post('employees/assessment/store', 'EmployeesAssessmentController@store')->name('employees.assessments.store');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::post('theme-settings/rtlThemeLang', ['uses' => 'ThemeSettingsController@rtlThemeFromLanguageChange'])->name('theme-settings.rtlThemeLang');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::get('tsub-ask-files/download/{id}', ['uses' => 'SubTaskFilesController@download'])->name('sub-task-files.download');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::get('all-invoices/update-item','ManageAllInvoicesController@addItems')->name('all-invoices.update-item');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::post('/purchases/move-products/{id}','PurchasesController@moveProducts' )->name('purchases.move-products');
                        Route::get('/purchases/requests/show','ManagePurchasesController@index')->name('purchases.show-requests');
                        // Route::get('purchases/requests-approve/{request_type?}/{id}',['uses' => 'ManagePurchasesController@approveRequest'])->name('purchases.approve-request');
                        Route::get('purchases/requests-approve/{id}',['uses' => 'ManagePurchasesController@approveRequest'])->name('purchases.approve-request');
                    }
                );
                Route::group(
                    ...
                    Route::post('/libraries/store/{request_type}/request',"LibraryController@saveRequest")->name('libraries.request.store');
                    Route::get('/libraries/requests/show','LibraryController@showRequests')->name('libraries.show-requests');
//                            Route::get('/libraries/requests/show','LibraryController@showFil')->name('libraries.show-requests');
...
//                Route::get('attendances/byDateData', ['uses' => 'ManageAttendanceController@byDateData'])->name('attendances.byDateData');
                ...
                Route::get('leaves/create-mission', ['uses' => 'ManageLeavesController@createMission'])->name('leave.create-mission');
    ...
    // Mark all notifications as read
        Route::post('show-clubMember-notifications', ['uses' => 'NotificationController@showClubMemberNotifications'])->name('show-clubMember-notifications');
...
Route::get('test-cron', 'App\Http\Controllers\CronController@testCron');
