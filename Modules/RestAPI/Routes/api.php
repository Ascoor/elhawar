...
ApiRoute::group(['namespace' => 'Modules\RestAPI\Http\Controllers','middleware' => 'api.auth'], function () {
    ...
    ApiRoute::get('sports/details', 'sportsController@details');
    ApiRoute::resource('sports', 'sportsController');
    ApiRoute::get('sportSessions/showSession/{id}', 'SportSessionsController@showSession');
    ApiRoute::post('sportSessions/subscribe/{id}', 'SportSessionsController@subscribe');
    ApiRoute::resource('sportSessions', 'SportSessionsController');
    ApiRoute::post('events/subscribe/{id}', 'TripsController@subscribe');
    ApiRoute::resource('events', 'TripsController');
    ApiRoute::get('notifications/markRead/{id}', 'NotificationsController@markRead');
    ApiRoute::resource('notifications', 'NotificationsController');
    ApiRoute::get('coaches/schedule/{id}', 'CoachesController@schedule');
    ApiRoute::resource('payments', 'PaymentController');
    ApiRoute::resource('gallery', 'GalleryController');
    ApiRoute::resource('invoices', 'InvoicesController');
    ApiRoute::resource('userProfile', 'FamilyMembersController');
    ...
    ApiRoute::post('fawrypay/pay-using-card', 'FawryPayController@payUsingCard');
    ApiRoute::post('fawrypay/pay-using-ref-code', 'FawryPayController@payUsingRefCode');
    ApiRoute::get('fawrypay/get-payment-status', 'FawryPayController@getPaymentStatus');
});
