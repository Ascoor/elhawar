...
@section('report-title') {{__('accounting::modules.accounting.receiptpaymentsheet')}} @endsection
...
@section('report-content')
    <table style="text-align: center"  cellpadding="3" >
        <thead>
            <tr>
                <th style="width: 50%">{{__('accounting::modules.accounting.receipts')}}</th>
                <th style="width: 50%">{{__('accounting::modules.accounting.payments')}}</th>
            </tr>
        </thead>
        <tbody>
            <tr>
