...
{{-- Needed Routes --}}
@section('createRoute'){{ route('admin.accounting.checks.create') }}@endsection
@section('destroyRoute'){{route('admin.accounting.checks.delete')}}@endsection
...
<div class="col-xs-12">
    ...
    <div class="form-group">
        <input type="text" class="form-control datepicker " style="margin-bottom:5px" id="start-date"
            placeholder="@lang('accounting::modules.accounting.from')" value="" />
        <input type="text" class="form-control datepicker " style="margin-bottom:5px" id="end-date"
            placeholder="@lang('accounting::modules.accounting.to')" value="" />
    </div>
</div>
...
<div class="col-xs-12">
    <h5> <i class="fa fa-file-text-o"></i> @lang('accounting::modules.accounting.checkStatus')</h5>
    <div class="form-group">
...
{{-- rola --}}
{{-- added the opending tags and clossing tags for script --}}
<script>
