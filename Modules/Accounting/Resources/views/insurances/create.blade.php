...
@section('form-panel-heading')@lang('accounting::modules.accounting.addNewInsurance')@endsection
@section('form-inputs')
...
<div class="form-group">
    ...
    <select class='form-select form-control' name='insuranceType' id='insuranceType' required>
        @foreach ($insuranceTypes as $type)
            <option value="{{$type->id}}" @if (old('insuranceType')==$type->id) selected @endif>{{$type->name}}</option>
        @endforeach
    </select>
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control datepicker" name="paymentDate" id="paymentDate" aria-describedby="helpId" value="{{old('paymentDate')}}" required>
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control datepicker" name="returnDate" id="returnDate" aria-describedby="helpId" value="{{old('returnDate')}}" required>
...
<div class="form-group">
    ...
    <textarea  class="form-control datepicker" name="purpose" id="purpose" aria-describedby="helpId">{{old('purpose')}}</textarea>
