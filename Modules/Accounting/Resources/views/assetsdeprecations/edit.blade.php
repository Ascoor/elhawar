...
@section('form-panel-heading')@lang('accounting::modules.accounting.editAssetDeprecation')@endsection
@section('form-inputs')
...
<div class="form-group">
  ...
  <select name="code_id" class='select2 form-control form-select' style='width:100%' required>
    <option value="{{$assetDeprecation['code_id']}}">{{$assetDeprecation->assetCode->breadcrumb}}</option>
  </select>
...
<div class="form-group">
    ...
    <input type='number' name='precentageOfDeprecation' class='form-control' step='0.1'  value="{{$assetDeprecation['precentageOfDeprecation']}}"  required>
...
<div class="form-group">
    ...
    <input type='number' name='numberOfYears' step='0.1'  class='form-control' value="{{$assetDeprecation['numberOfYears']}}"  required>
