        ...
        <div class="white-box">
            ...
            <div class="row" id="ticket-filters">
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="checkbox checkbox-info">
                            <input id="mark_leaves_paid" name="mark_leaves_paid" type="checkbox">
                            <label
                                for="mark_leaves_paid">@lang('payroll::modules.payroll.markApprovedLeavesPaid')</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="checkbox checkbox-info">
                            <input id="markLate3Days1AbsentUnpaid" name="markLate3Days1AbsentUnpaid" type="checkbox">
                            <label
                                for="markLate3Days1AbsentUnpaid">@lang('payroll::modules.payroll.markLate3Days1AbsentUnpaid')</label>
                        </div>
                    </div>
                </div>
                {{-- rola changed col-md-3 to col-md-4 --}}
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="checkbox checkbox-info">
                            <input id="markPermission3Days1AbsentUnpaid" name="markPermission3Days1AbsentUnpaid"
                                type="checkbox">
                            <label
                                for="markPermission3Days1AbsentUnpaid">@lang('payroll::modules.payroll.markPermission3Days1AbsentUnpaid')</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="checkbox checkbox-info">
                            <input id="markLate2HalfDay1AbsentUnpaid" name="markLate2HalfDay1AbsentUnpaid"
                                type="checkbox">
                            <label
                                for="markLate2HalfDay1AbsentUnpaid">@lang('payroll::modules.payroll.markLate2HalfDay1AbsentUnpaid')</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="checkbox checkbox-info">
                            <input id="useAttendance" name="useAttendance" type="checkbox">
                ...
                <div class="col-md-4" style="display:none">
                    <div class="form-group">
                        <div class="checkbox checkbox-info  ">
                            <input id="includeExpenseClaims" name="includeExpenseClaims" type="checkbox">
                            <label
                                for="includeExpenseClaims">@lang('payroll::modules.payroll.includeExpenseClaims')</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-d" style="display:none">
                    <div class="form-group">
                        <div class="checkbox checkbox-info  ">
                ...
                <div class="row">
                    {{-- BUTTON GENERATE --}}
                    <div class="col-md-3" id="generate-buttons">
                        <div class="form-group">
                            <button type="button" id="generate-payslip" class="btn btn-success"><i
                                    class="fa fa-send"></i> @lang('payroll::modules.payroll.generate') </button>
                        </div>
                    </div>
                    <div class="col-md-3" id="regenerate-buttons">
                        <div class="form-group">
                            <button type="button" id="regenerate-payslip" class="btn btn-success"><i
                                    class="fa fa-send"></i> @lang('payroll::modules.payroll.regenerate') </button>
                            <button type="button" id="show-status-modal" class="btn btn-info"><i class="fa fa-tag"></i>
                                @lang('app.status') </button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-4" id="generateAllEmployees" style="display: none">
                            <div class="form-group">
                                <button id="generateAllEmployeesBt" class="btn btn-success"><i class="fa fa-send"></i>
                                    @lang('payroll::modules.monthSlip')
                                    {{-- GENERATE ALL EMPLOYEE MONTH SALARY --}}
                                 </button>
                            </div>
                        </div>
                        <div class="col-md-4" id="monthSlipInsured" style="display: none">
                            <div class="form-group">
                                <button id="monthSlipInsuredBt" class="btn btn-success"><i class="fa fa-send"></i>
                                    @lang('payroll::modules.monthSlipInsured') RRRRRRRRRRRRRRRRR</button>
                            </div>
                        </div>
                        <div class="col-md-4" id="monthSlipNotInsured" style="display: none">
                            <div class="form-group">
                                <button id="monthSlipNotInsuredBt" class="btn btn-success"><i class="fa fa-send"></i>
                                    @lang('payroll::modules.monthSlipNotInsured') </button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-4" id="salaryResources" style="display: none">
                        <div class="form-group">
                            <button id="salaryResourcesBt" class="btn btn-success"><i class="fa fa-send"></i>
                                @lang('payroll::modules.salaryResources') </button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row p-b-5">
                    <div class="col-sm-4">
                        <div class="radio radio-inverse">
                            ...
                            <label for="status_generated"
                                class="text-inverse">@lang('payroll::modules.payroll.generated')</label>
                        </div>
                    </div>
                ...
                <div class="row p-t-5 p-b-5">
                    <div class="col-sm-4">
                        <div class="radio radio-info">
                            ...
                            <label for="status_review"
                                class="text-info">@lang('payroll::modules.payroll.review')</label>
                        </div>
                    </div>
                ...
                <div class="row p-t-5 p-b-5">
                    <div class="col-sm-4">
                        <div class="radio radio-danger">
                            ...
                            <label for="status_locked"
                                class="text-danger">@lang('payroll::modules.payroll.locked')</label>
                        </div>
                    </div>
                ...
                <div class="row p-t-5 p-b-5" id="payment-fields">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                value="{{ \Carbon\Carbon::now()->timezone($global->timezone)->format($global->date_format) }}"
                                name="paid_on" id="paid_on" class="form-control" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
<script>
    ...
    $(function() {
        ...
        $('body').on('click', '#generate-payslip', function(){
            ...
            var generateAllEmployeesVar = document.getElementById('generateAllEmployees')
            var monthSlipInsuredVar = document.getElementById('monthSlipInsured')
            var monthSlipNotInsuredVar = document.getElementById('monthSlipNotInsured')
            var salaryResourcesVar = document.getElementById('salaryResources')
            ...
            if ($('#markLate3Days1AbsentUnpaid').is(':checked')) {
                var markLate3Days1AbsentUnpaid = '1';
            } else {
                var markLate3Days1AbsentUnpaid = '0';
            }
            if ($('#markPermission3Days1AbsentUnpaid').is(':checked')) {
                var markPermission3Days1AbsentUnpaid = '1';
            } else {
                var markPermission3Days1AbsentUnpaid = '0';
            }
            if ($('#markLate2HalfDay1AbsentUnpaid').is(':checked')) {
                var markLate2HalfDay1AbsentUnpaid = '1';
            } else {
                var markLate2HalfDay1AbsentUnpaid = '0';
            }
            ...
            $.easyAjax({
                ...
                data: {
                    ...
                    markLate3Days1AbsentUnpaid: markLate3Days1AbsentUnpaid,
                    markPermission3Days1AbsentUnpaid: markPermission3Days1AbsentUnpaid,
                    markLate2HalfDay1AbsentUnpaid: markLate2HalfDay1AbsentUnpaid,
                ...
                success: function (response) {
                    if(response.status == "success"){
                        generateAllEmployeesVar.style.display='block';
                        monthSlipInsuredVar.style.display='block';
                        monthSlipNotInsuredVar.style.display='block';
                        salaryResourcesVar.style.display='block';
                        $.unblockUI();
                        loadTable();
                    }
                }
        ...
        /////
        $('body').on('click', '#generateAllEmployeesBt',function (){
            var month = $('#month').val();
            var year  = $('#year').val();
            var url = '{{route('admin.payroll.showMonthlyPayrollList')}}';
            url=url+'/:month'+'/:year';
            url = url.replace(':month', month );
            url = url.replace(':year', year);
            location.href=url;
        });
        $('body').on('click', '#monthSlipInsuredBt',function (){
            var month = $('#month').val();
            var year  = $('#year').val();

            // rola Note : goes to the function name in the controller
            var url = '{{route('admin.payroll.showMonthlyPayrollLisInsured')}}';

            // showMonthlyPayrollList
            url=url+'/:month'+'/:year';
            url = url.replace(':month', month );
            url = url.replace(':year', year);
            location.href=url;
        ...
        $('body').on('click', '#monthSlipNotInsuredBt',function (){
            var month = $('#month').val();
            var year  = $('#year').val();
            var url = '{{route('admin.payroll.showMonthlyPayrollListNotInsured')}}';
            url=url+'/:month'+'/:year';
            url = url.replace(':month', month );
            url = url.replace(':year', year);
            location.href=url;
        });
        $('body').on('click', '#salaryResourcesBt',function (){
            var month = $('#month').val();
            var year  = $('#year').val();
            var url = '{{route('admin.payroll.salaryResources')}}';
            url=url+'/:month'+'/:year';
            url = url.replace(':month', month );
            url = url.replace(':year', year);
            location.href=url;
    ...
    function loadTable(){
        ...
        // rrrr shows the table of epmployees
