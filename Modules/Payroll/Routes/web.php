    ...
    Route::group(
        ...
        function () {
            Route::prefix('payroll')->group(function () {
                ...
                Route::get('payroll/showMonthlyPayrollList/{month?}/{year?}', ['uses' => 'PayrollController@showMonthlyPayrollList'])->name('payroll.showMonthlyPayrollList');
                Route::get('payroll/showMonthlyPayrollLisInsured/{month?}/{year?}', ['uses' => 'PayrollController@showMonthlyPayrollLisInsured'])->name('payroll.showMonthlyPayrollLisInsured');
                Route::get('payroll/showMonthlyPayrollListNotInsured/{month?}/{year?}', ['uses' => 'PayrollController@showMonthlyPayrollListNotInsured'])->name('payroll.showMonthlyPayrollListNotInsured');
                Route::get('payroll/salaryResources/{month?}/{year?}', ['uses' => 'PayrollController@salaryResources'])->name('payroll.salaryResources');
